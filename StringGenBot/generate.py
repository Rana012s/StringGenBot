...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    if is_bot:
        ty += " 𝐁ᴏᴛ"
    await msg.reply(f"» 𝐓ʀʏɪɴɢ 𝐓ᴏ 𝐒ᴛᴀʀᴛ **{ty}** 𝐒ᴇssɪᴏɴ 𝐆ᴇɴᴇʀᴀᴛᴏʀ...")
    user_id = msg.chat.id
    ...
    if api_id_msg.text == "/skip":
        ...
        try:
            ...
            return
        api_hash_msg = await msg.chat.ask("» 𝐍ᴏᴡ 𝐏ʟᴇᴀsᴇ 𝐒ᴇɴᴅ 𝐘ᴏᴜʀ **ᴀᴩɪ_ʜᴀsʜ** 𝐓ᴏ 𝐂ᴏɴᴛɪɴᴜᴇ", filters=filters.text)
        if await cancelled(api_hash_msg):
            return
        api_hash = api_hash_msg.text
    if not is_bot:
        t = "» 𝐏ʟᴇᴀsᴇ 𝐒ᴇɴᴅ 𝐘ᴏᴜʀ **ᴩʜᴏɴᴇ_ɴᴜᴍʙᴇʀ** 𝐖ɪᴛʜ 𝐂ᴏᴜɴᴛʀʏ 𝐂ᴏᴅᴇ 𝐅ᴏʀ 𝐖ʜɪᴄʜ 𝐘ᴏᴜ 𝐖ᴀɴᴛ 𝐓ᴏ 𝐆𝐞ɴᴇʀᴀᴛᴇ sᴇssɪᴏɴ. \nᴇxᴀᴍᴩʟᴇ : `+910000000000`'"
    else:
    ...
    text = f"**ᴛʜɪs ɪs ʏᴏᴜʀ {ty} sᴛʀɪɴɢ sᴇssɪᴏɴ** \n\n`{string_session}` \n\n**ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :** @Ranastringsessionbot\n🍒 **ɴᴏᴛᴇ :** ᴅʀᴏᴘ ʏᴏᴜʀ ɢғ ɴᴜᴅᴇs  🍑 ᴀɴᴅ ᴅᴏɴ'ᴛ sʜᴀʀᴇ ᴀɴʏᴏɴᴇ ғᴏʀɢᴇᴛ ᴛᴏ ᴊᴏɪɴ @RANA_societyyyy 🥺"
    try:
        if not is_bot:
